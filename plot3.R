...
#set Graphic device to be plot3.PNG 
png(file="/Users/winkulvichit/Dropbox/Educations/Visualization/coursera assignment/ExData_Plotting1/plot3.png", width = 480, height = 480)
